...
var int_command_1 = require("./commands/int_command");
...
var LineExecutor = /** @class */ (function () {
    ...
    LineExecutor.prototype.execLine = function (line) {
        ...
        switch (command) {
            case 'ABS':
                abs_command_1.default(message);
                break;
            case 'CLS':
                cls_command_1.default();
                break;
            case 'END':
                end_command_1.default();
                break;
            case 'INT':
                int_command_1.default(message);
                break;
            case 'PRINT':
                print_command_1.default(message);
                break;
            case 'REM':
                break;
            case '':
